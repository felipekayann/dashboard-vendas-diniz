...
async function main() {
  ...
  try {
    ...
    // O site so precisa ser republicado quando o saldo do mes vira (1x por dia).
    // Nas demais rodadas o dashboard ja le tudo do cofre, entao nao commitamos.
    fs.writeFileSync('commitar.txt', precisaRecalcular ? 'sim' : 'nao');
